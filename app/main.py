...
from app.controller import flex_quest_filter, choose_todays
from app.database import QuestStatus, QuestRarity, Quest, SessionLocal, CheckboxSubtask, NumericSubtask
...
@app.post("/subtask/{subtask_id}/checkbox")
...
@app.post("/subtask/{subtask_id}/numeric")
...
@app.get("/quest/{quest_id}/progress")
